...
export const templatePreviews: Record<string, string> = {
  ...
  'casino-landing': base(`
    <div style="padding:12px;background:#161625">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:4px">${['🎰','🃏','🎲','⭐','🎯','💎'].map(e => `<div style="background:#2a2a3a;border-radius:4px;padding:6px;text-align:center;border:1px solid #444"><div style="font-size:14px">${e}</div><div style="font-size:5px;color:#bbb;margin-top:2px">Play</div></div>`).join('')}</div>
    </div>
  `, '#161625', '#fff'),

  'casino-slots': base(`
    <div style="padding:12px;background:#161625;text-align:center">
      <div style="font-size:10px;font-weight:700;color:#fbbf24;margin-bottom:6px">🎰 MEGA SLOTS</div>
      <div style="background:#1e1e32;border-radius:8px;padding:8px;border:2px solid #fbbf2440;display:inline-block">
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:4px;margin-bottom:6px">${['🍒','💎','7️⃣','⭐','🍋','🔔','💎','7️⃣','🍒'].map(e => `<div style="background:#2a2a3a;border-radius:4px;padding:6px;font-size:14px">${e}</div>`).join('')}</div>
      ...
      <div style="margin-top:6px;font-size:7px;color:#aaa">Balance: $1,000.00</div>
    </div>
  `, '#161625', '#fff'),
  ...
  'casino-poker': base(`
    <div style="padding:10px;background:#186018;border-radius:8px;position:relative">
  ...
  'casino-blackjack': base(`
    <div style="padding:10px;background:#186018">
      <div style="text-align:center;font-size:7px;color:#d4a853;margin-bottom:6px">♠ BLACKJACK ♠</div>
      <div style="text-align:center;margin-bottom:4px"><div style="font-size:5px;color:#bbb">DEALER (17)</div><div style="display:flex;gap:2px;justify-content:center;margin-top:2px">${['K♠','7♣'].map(c => `<div style="width:18px;height:26px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:6px;font-weight:700">${c}</div>`).join('')}</div></div>
      <div style="text-align:center;margin-top:8px"><div style="font-size:5px;color:#bbb">YOUR HAND (20)</div><div style="display:flex;gap:2px;justify-content:center;margin-top:2px">${['Q♥','10♦'].map(c => `<div style="width:20px;height:28px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:7px;font-weight:700;color:#c0392b;border:1px solid #d4a853">${c}</div>`).join('')}</div></div>
  ...
  // ═══════════════════════════════════════════
  'casino-crash': base(`
    <div style="padding:8px;background:#161625;height:200px;position:relative">
      <div style="font-size:7px;color:#aaa;margin-bottom:4px">CRASH</div>
  ...
  'casino-mines': base(`
    <div style="padding:10px;background:#161625">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">MINES — <span style="color:#22c55e">3.24x</span></div>
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:3px;margin-bottom:6px">
        ${Array.from({length:25}).map((_,i) => {
          ...
          return `<div style="width:100%;aspect-ratio:1;background:#2a2a3a;border:1px solid #444;border-radius:3px"></div>`
        }).join('')}
      </div>
  ...
  'casino-plinko': base(`
    <div style="padding:6px;background:#161625;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:4px">PLINKO</div>
  ...
  'casino-wheel': base(`
    <div style="padding:8px;background:#161625;text-align:center">
      <div style="font-size:8px;font-weight:700;color:#fbbf24;margin-bottom:4px">🎡 WHEEL OF FORTUNE</div>
      <div style="width:90px;height:90px;border-radius:50%;background:conic-gradient(#ef4444 0deg,#f59e0b 30deg,#22c55e 60deg,#3b82f6 90deg,#8b5cf6 120deg,#ec4899 150deg,#ef4444 180deg,#f59e0b 210deg,#22c55e 240deg,#3b82f6 270deg,#8b5cf6 300deg,#ec4899 330deg,#ef4444 360deg);margin:0 auto;border:3px solid #fbbf24;display:flex;align-items:center;justify-content:center;box-shadow:0 0 20px #fbbf2440"><div style="width:20px;height:20px;border-radius:50%;background:#161625;border:2px solid #fbbf24;display:flex;align-items:center;justify-content:center;font-size:6px;color:#fbbf24;font-weight:700">▶</div></div>
      <div style="font-size:5px;color:#aaa;margin-top:4px">Click to spin • Balance: $500</div>
    </div>
  `, '#161625', '#fff'),

  'casino-baccarat': base(`
    <div style="padding:8px;background:#186018">
      ...
      <div style="display:flex;justify-content:space-around;margin-bottom:6px">
        <div style="text-align:center"><div style="font-size:5px;color:#bbb">PLAYER (8)</div><div style="display:flex;gap:2px;margin-top:2px">${['9♠','K♣'].map(c => `<div style="width:16px;height:22px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:5px;font-weight:700">${c}</div>`).join('')}</div></div>
        <div style="text-align:center"><div style="font-size:5px;color:#bbb">BANKER (6)</div><div style="display:flex;gap:2px;margin-top:2px">${['J♥','6♦'].map(c => `<div style="width:16px;height:22px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:5px;font-weight:700;color:#c0392b">${c}</div>`).join('')}</div></div>
      </div>
  ...
  'casino-keno': base(`
    <div style="padding:6px;background:#181845">
      ...
      <div style="display:grid;grid-template-columns:repeat(10,1fr);gap:1px;margin-bottom:4px">
        ${Array.from({length:40}).map((_,i) => {
          ...
          return `<div style="text-align:center;font-size:4px;padding:2px;border-radius:2px;font-weight:600;${hit?'background:#22c55e;color:#000':sel?'background:#3b82f6;color:#fff':'background:#282850;color:#999'}">${n}</div>`
        }).join('')}
      </div>
      <div style="text-align:center;font-size:5px;color:#aaa">Hits: 3/7 — Win: $45.00</div>
    </div>
  `, '#181845', '#e2e8f0'),

  'casino-video-poker': base(`
    <div style="padding:8px;background:#181845">
  ...
  'casino-hilo': base(`
    <div style="padding:10px;background:#161625;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">HI-LO • <span style="color:#22c55e">1.86x</span></div>
      ...
      <div style="display:flex;gap:2px;justify-content:center">${['3♣','J♠','5♦','K♥','8♣'].map(c => `<div style="width:14px;height:20px;background:#2a2a3a;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:5px;color:#aaa">${c}</div>`).join('')}</div>
    </div>
  `, '#161625', '#fff'),

  'casino-aviator': base(`
    <div style="padding:8px;background:#2d1818;height:200px;position:relative">
  ...
  'casino-sports': base(`
    <div style="display:flex;height:200px;background:#161625">
      <div style="width:30px;background:#1e1e32;padding:4px 2px;font-size:6px">${['⚽','🏀','🎾','🥊','🎮'].map(e => `<div style="text-align:center;margin:6px 0">${e}</div>`).join('')}</div>
      <div style="flex:1;padding:6px">
        <div style="font-size:8px;font-weight:700;color:#fff;margin-bottom:6px">⚽ Football</div>
        ${[{t1:'Barcelona',t2:'Real Madrid',o:['1.85','3.50','4.20']},{t1:'Liverpool',t2:'Man City',o:['2.10','3.30','3.40']}].map(m => `<div style="background:#1e1e32;border-radius:4px;padding:4px;margin-bottom:4px;border:1px solid #383848"><div style="display:flex;justify-content:space-between;font-size:6px;margin-bottom:3px"><span style="color:#fff">${m.t1} vs ${m.t2}</span><span style="color:#22c55e;font-size:5px">LIVE</span></div><div style="display:flex;gap:2px">${m.o.map((o,i) => `<div style="flex:1;text-align:center;padding:2px;background:#252545;border-radius:2px;font-size:6px;font-weight:600;color:#3b82f6">${['1','X','2'][i]} ${o}</div>`).join('')}</div></div>`).join('')}
      </div>
    </div>
  `, '#161625', '#fff'),
  ...
  'casino-dice-game': base(`
    <div style="padding:10px;background:#161625;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">DICE — Roll Over</div>
      <div style="background:#1e1e32;border-radius:6px;padding:8px;margin-bottom:6px">
        <div style="width:100%;height:6px;background:#252545;border-radius:3px;position:relative;margin-bottom:4px"><div style="width:55%;height:100%;background:linear-gradient(90deg,#ef4444,#f59e0b);border-radius:3px"></div><div style="position:absolute;left:55%;top:-3px;width:8px;height:12px;background:#fff;border-radius:2px;transform:translateX(-50%)"></div></div>
        <div style="display:flex;justify-content:space-between;font-size:5px;color:#aaa"><span>0</span><span style="color:#22c55e;font-weight:700">55.00</span><span>100</span></div>
      </div>
      <div style="font-size:14px;font-weight:800;color:#22c55e;margin-bottom:4px">72.41</div>
      <div style="font-size:5px;color:#aaa">Win Chance: 45% • Multiplier: 2.18x</div>
    </div>
  `, '#161625', '#fff'),

  'casino-scratch': base(`
    <div style="padding:10px;background:#252545;text-align:center">
  ...
  'casino-bingo': base(`
    <div style="padding:8px;background:#2d0850">
      ...
      <div style="display:flex;gap:6px;justify-content:center">
        <div><div style="display:grid;grid-template-columns:repeat(5,1fr);gap:1px">
          ...
          ${Array.from({length:25}).map((_,i) => {const n=i+1;const hit=[3,8,12,17,22].includes(n);return `<div style="width:14px;height:14px;font-size:5px;display:flex;align-items:center;justify-content:center;border-radius:2px;${hit?'background:#ec4899;color:#fff;font-weight:700':'background:#282850;color:#aaa'}">${n}</div>`}).join('')}
        </div></div>
        <div style="text-align:center"><div style="font-size:16px;margin-bottom:2px">🎱</div><div style="font-size:12px;font-weight:800;color:#fbbf24">42</div><div style="font-size:5px;color:#aaa">Called</div></div>
      </div>
    </div>
  `, '#2d0850', '#e2e8f0'),
  ...
  'casino-coin-flip': base(`
    <div style="padding:12px;background:#161625;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:8px">COIN FLIP</div>
      ...
      <div style="font-size:5px;color:#aaa;margin-top:6px">Streak: 3 🔥 • Balance: $250</div>
    </div>
  `, '#161625', '#fff'),

  'casino-lottery': base(`
    <div style="padding:8px;background:#181845;text-align:center">
      ...
      <div style="font-size:5px;color:#aaa;margin-bottom:6px">Next draw in 04:32:18</div>
  ...
  'casino-limbo': base(`
    <div style="padding:12px;background:#161625;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:8px">LIMBO</div>
      <div style="font-size:28px;font-weight:800;color:#22c55e;margin-bottom:8px">1.47x</div>
      <div style="background:#1e1e32;border-radius:6px;padding:6px;margin-bottom:6px"><div style="font-size:5px;color:#aaa;margin-bottom:2px">Target: 2.00x</div><div style="font-size:5px;color:#aaa">Win Chance: 49.5%</div></div>
  ...
  'casino-tower': base(`
    <div style="padding:8px;background:#161625">
      <div style="font-size:7px;color:#aaa;margin-bottom:4px">TOWER — <span style="color:#fbbf24">4.8x</span></div>
      <div style="display:flex;flex-direction:column;gap:2px;margin-bottom:4px">${Array.from({length:6}).map((_,i) => `<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2px">${Array.from({length:3}).map((_,j) => `<div style="height:10px;border-radius:2px;${i>3?'background:#22c55e20;border:1px solid #22c55e':i===3&&j===1?'background:#fbbf2440;border:1px solid #fbbf24':'background:#2a2a3a;border:1px solid #444'}"></div>`).join('')}</div>`).join('')}
  ...
  'casino-live-landing': base(`
    <div style="padding:10px;background:#161625">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:3px">${['🃏 Blackjack','🎡 Roulette','🃏 Baccarat'].map(g => `<div style="background:#2a2a3a;border:1px solid #ef444420;border-radius:4px;padding:6px;text-align:center"><div style="font-size:6px;color:#fff">${g}</div><div style="font-size:4px;color:#ef4444;margin-top:2px">LIVE</div></div>`).join('')}</div>
    </div>
  `, '#161625', '#fff'),
  ...
  'casino-poker-room': base(`
    <div style="padding:8px;background:#186018">
      ...
      ${[{n:'Table 1',s:'$1/$2 NL',p:'6/9'},{n:'Tournament',s:'$50 Buy-in',p:'124'}].map(t => `<div style="background:#145214;border:1px solid #d4a85320;border-radius:4px;padding:4px;margin-bottom:3px;display:flex;justify-content:space-between;font-size:5px"><span style="color:#fff">${t.n}</span><span style="color:#d4a853">${t.s}</span><span style="color:#aaa">${t.p} players</span></div>`).join('')}
    </div>
  `, '#186018', '#fff'),
  ...
  'casino-slots-5reel': base(`
    <div style="padding:8px;background:#161625;text-align:center">
      ...
      <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:2px;background:#1e1e32;border:2px solid #fbbf2430;border-radius:6px;padding:4px">${['👁️','🐍','💎','🏛️','⭐','🐪','👁️','💎','🐍','🏛️','⭐','👁️','🐪','💎','🐍'].map(s => `<div style="background:#2a2a3a;border-radius:2px;padding:3px;font-size:8px">${s}</div>`).join('')}</div>
  ...
  'casino-slots-progressive': base(`
    <div style="padding:8px;background:#0a0a1a;text-align:center">
      <div style="font-size:6px;color:#aaa;margin-bottom:2px">PROGRESSIVE JACKPOT</div>
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2px;margin-bottom:4px">${['Mini $50','Minor $500','Major $5K','Grand $$$'].map((j,i) => `<div style="background:#1e1e32;border:1px solid ${['#22c55e','#3b82f6','#a855f7','#fbbf24'][i]}30;border-radius:3px;padding:2px;font-size:4px;color:${['#22c55e','#3b82f6','#a855f7','#fbbf24'][i]}">${j}</div>`).join('')}</div>
    </div>
  `, '#0a0a1a', '#fff'),
  ...
  'casino-dragon-tiger': base(`
    <div style="padding:10px;background:#3d0a0a;text-align:center">
      ...
      <div style="display:flex;justify-content:space-around;margin-bottom:6px">${[{n:'DRAGON',c:'A♠'},{n:'TIGER',c:'K♥'}].map(s => `<div><div style="font-size:5px;color:#aaa">${s.n}</div><div style="width:22px;height:30px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:8px;font-weight:700;color:${s.c.includes('♥')?'#c0392b':'#111'};margin:2px auto">${s.c}</div></div>`).join('')}</div>
  ...
  'game2d-breakout': base(`
    <div style="padding:12px;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">BREAKOUT</div>
  ...
  'game2d-pong': base(`
    <div style="padding:12px;text-align:center;position:relative;height:100px">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">PONG</div>
  ...
  'game2d-tower-defense': base(`
    <div style="padding:12px">
      <div style="display:flex;justify-content:space-between;margin-bottom:6px">
        <span style="font-size:7px;color:#aaa">TOWER DEFENSE</span>
  ...
  'game2d-match3': base(`
    <div style="padding:12px;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">MATCH 3</div>
  ...
  'game2d-maze': base(`
    <div style="padding:12px;text-align:center">
      <div style="font-size:7px;color:#aaa;margin-bottom:6px">MAZE RUNNER</div>
      <div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;max-width:80px;margin:0 auto">
        ...
        <div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div>
        <div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div>
        <div style="background:#333;height:10px"></div><div style="background:#252545;height:10px;display:flex;align-items:center;justify-content:center"><div style="width:5px;height:5px;background:#3b82f6;border-radius:50%"></div></div><div style="background:#252545;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#333;height:10px"></div>
        <div style="background:#333;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#333;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#252545;height:10px"></div><div style="background:#22c55e;height:10px"></div>
      </div>
      <div style="font-size:6px;color:#999;margin-top:6px">Find the exit 🏁</div>
    </div>
  `, '#161625', '#fff'),
}
