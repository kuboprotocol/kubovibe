...
export const templatePreviews: Record<string, string> = {
  ...
  'casino-baccarat': base(`
    <div style="padding:8px;background:#259025">
      ...
      <div style="display:flex;justify-content:space-around;margin-bottom:6px">
        ...
        <div style="text-align:center"><div style="font-size:5px;color:#ddd">BANKER (6)</div><div style="display:flex;gap:2px;margin-top:2px">${['J♥','6♦'].map(c => `<div style="width:16px;height:22px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:5px;font-weight:700;color:#c0392b">${c}</div>`).join('')}</div></div>
      </div>
  ...
  'casino-dragon-tiger': base(`
    <div style="padding:10px;background:#3d0a0a;text-align:center">
      ...
      <div style="display:flex;justify-content:space-around;margin-bottom:6px">${[{n:'DRAGON',c:'A♠'},{n:'TIGER',c:'K♥'}].map(s => `<div><div style="font-size:5px;color:#ccc">${s.n}</div><div style="width:22px;height:30px;background:#fff;border-radius:2px;display:flex;align-items:center;justify-content:center;font-size:8px;font-weight:700;color:${s.c.includes('♥')?'#c0392b':'#111'};margin:2px auto">${s.c}</div></div>`).join('')}</div>
  ...
  'game2d-breakout': base(`
    <div style="padding:12px;text-align:center">
      <div style="font-size:7px;color:#ccc;margin-bottom:6px">BREAKOUT</div>
  ...
  'game2d-pong': base(`
    <div style="padding:12px;text-align:center;position:relative;height:100px">
      <div style="font-size:7px;color:#ccc;margin-bottom:6px">PONG</div>
  ...
  'game2d-tower-defense': base(`
    <div style="padding:12px">
      <div style="display:flex;justify-content:space-between;margin-bottom:6px">
        <span style="font-size:7px;color:#ccc">TOWER DEFENSE</span>
  ...
  'game2d-match3': base(`
    <div style="padding:12px;text-align:center">
      <div style="font-size:7px;color:#ccc;margin-bottom:6px">MATCH 3</div>
