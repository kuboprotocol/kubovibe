        ...
        <div className="space-y-10 text-foreground/90 leading-relaxed">
          <section>
            ...
            <p className="text-muted-foreground">
              By accessing or using {APP_NAME} ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use the Platform. {APP_NAME} reserves the right to update these terms at any time, and continued use constitutes acceptance of any changes.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <li>{APP_NAME} reserves the right to suspend or terminate accounts that violate these terms.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-3">
              All code generated through the Platform belongs to you. You retain full ownership and rights to use, modify, distribute, and commercialize any applications created using {APP_NAME}.
            </p>
            <p className="text-muted-foreground">
              The {APP_NAME} brand, logo, design, and underlying technology are the exclusive property of KUBO PROTOCOL and are protected by intellectual property laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              {APP_NAME} aims to provide reliable service but does not guarantee 100% uptime. The Platform may be temporarily unavailable due to maintenance, updates, or unforeseen technical issues. We will make reasonable efforts to notify users of planned downtime in advance.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              To the maximum extent permitted by law, {APP_NAME} and KUBO PROTOCOL shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or business opportunities, arising from your use of the Platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              {APP_NAME} may terminate or suspend your access to the Platform at any time, with or without cause, with or without notice. Upon termination, your right to use the Platform ceases immediately, though you retain ownership of any previously generated and exported code.
            </p>
          </section>
